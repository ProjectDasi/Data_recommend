...
def tfidf_vectorize(texts):
    vectorizer = TfidfVectorizer()  # 최대 768개의 중요한 단어만 벡터화
...
process_and_save(file_paths['combined_cleaned'], 'combined_cleaned', r'C:\Users\lenovo\Desktop\dasi\model_cosine\data\vector_data(edu)\tfidf_vectorized_combined_cleaned.csv')

# 2. organization 벡터화
process_and_save(file_paths['organization'], 'organization', r'C:\Users\lenovo\Desktop\dasi\model_cosine\data\vector_data(edu)\tfidf_vectorized_organization.csv')
