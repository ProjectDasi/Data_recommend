...
# 데이터 로드 경로들
file_paths = {
    'combined_cleaned': './model_cosine/data/cleaned_job_data_no_nan_fixed(1030).csv',
}
...
process_and_save(file_paths['combined_cleaned'], 'combined_cleaned', './model_cosine/data/vector_data/kcbert_vectorized_combined_cleaned(1030).csv')
